...
const CharacterCard = ({ character, index, onClick }) => {
  const getRarityGradient = (rarity) => {
    switch (rarity) {
      case 5: return 'from-amber-500/20 to-yellow-500/20';
      case 4: return 'from-purple-500/20 to-violet-500/20';
  ...
  return (
    ...
    >
      <div className={`relative rounded-lg overflow-hidden aspect-square
        ...
        <img
          src={character.icon || `/characters/${character.id}_icon.webp`}
          alt={character.name}
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="flex-1 max-w-md relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 rounded-lg bg-white/5 
                       backdrop-blur-sm border border-white/10 text-sm 
